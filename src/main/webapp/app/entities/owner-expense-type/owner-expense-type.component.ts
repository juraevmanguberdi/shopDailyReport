...
export default class OwnerExpenseType extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllOwnerExpenseTypes();
  }
  ...
  public retrieveAllOwnerExpenseTypes(): void {
  ...
  public prepareRemove(instance: IOwnerExpenseType): void {
  ...
  public removeOwnerExpenseType(): void {
    this.ownerExpenseTypeService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('shopDailyReportApp.ownerExpenseType.deleted', { param: this.removeId });
