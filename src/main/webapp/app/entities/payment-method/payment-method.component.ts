...
export default class PaymentMethod extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllPaymentMethods();
  }
  ...
  public retrieveAllPaymentMethods(): void {
  ...
  public prepareRemove(instance: IPaymentMethod): void {
  ...
  public removePaymentMethod(): void {
    this.paymentMethodService()
      ...
      .then(() => {
        const message = this.$t('shopDailyReportApp.paymentMethod.deleted', { param: this.removeId });
