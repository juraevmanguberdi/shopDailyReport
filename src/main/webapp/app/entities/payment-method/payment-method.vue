<template>
  <div>
    <h2 id="page-heading" data-cy="PaymentMethodHeading">
      <span v-text="$t('shopDailyReportApp.paymentMethod.home.title')" id="payment-method-heading">Payment Methods</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('shopDailyReportApp.paymentMethod.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'PaymentMethodCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('shopDailyReportApp.paymentMethod.home.createLabel')"> Create a new Payment Method </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && paymentMethods && paymentMethods.length === 0">
      <span v-text="$t('shopDailyReportApp.paymentMethod.home.notFound')">No paymentMethods found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="$t('shopDailyReportApp.paymentMethod.name')">Name</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('code')">
              <span v-text="$t('shopDailyReportApp.paymentMethod.code')">Code</span>
            ...
            <th scope="row" v-on:click="changeOrder('note')">
              <span v-text="$t('shopDailyReportApp.paymentMethod.note')">Note</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="shopDailyReportApp.paymentMethod.delete.question"
      ...
      <div class="modal-body">
        <p id="jhi-delete-paymentMethod-heading" v-text="$t('shopDailyReportApp.paymentMethod.delete.question', { id: removeId })">
