...
export default class ExpenseType extends Vue {
  ...
  public retrieveAllExpenseTypes(): void {
  ...
  public prepareRemove(instance: IExpenseType): void {
  ...
  public removeExpenseType(): void {
    this.expenseTypeService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('shopDailyReportApp.expenseType.deleted', { param: this.removeId });
