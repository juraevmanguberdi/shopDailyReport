...
/**
 * A DTO for the {@link com.shop.report.domain.AssetLive} entity.
 */
public class AssetLiveDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssetLiveDTO)) {
            return false;
        }

        AssetLiveDTO assetLiveDTO = (AssetLiveDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, assetLiveDTO.id);
    }
