...
import PaymentMethodComponent from '@/entities/payment-method/payment-method.vue';
import PaymentMethodClass from '@/entities/payment-method/payment-method.component';
...
describe('Component Tests', () => {
  describe('PaymentMethod Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PaymentMethodClass>(PaymentMethodComponent, {
        store,
        i18n,
        localVue,
    ...
    it('Should call load all on init', async () => {
      ...
      // WHEN
      comp.retrieveAllPaymentMethods();
      await comp.$nextTick();
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(paymentMethodServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(paymentMethodServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
