...
describe('Register Component', () => {
  ...
  const filledRegisterAccount = { email: 'jhi@pster.net', langKey: 'uz-Cyrl-uz', login: 'jhi', password: 'jhipster' };
  ...
  it('should register when password match', async () => {
    ...
    expect(
      axiosStub.post.calledWith('api/register', { email: 'jhi@pster.net', langKey: 'uz-Cyrl-uz', login: 'jhi', password: 'jhipster' })
    ).toBeTruthy();
